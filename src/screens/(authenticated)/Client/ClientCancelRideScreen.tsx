...
const REASONS = [
  ...
  { id: "too_expensive", label: "Preço muito alto" },
  { id: "long_wait", label: "Demora para encontrar motorista" },
  { id: "other", label: "Outro" },
];

export default function ClientCancelRideScreen() {
  const navigation = useNavigation();
  const route = useRoute<RouteProp<Params, "ClientCancelRide">>();
  const rideId = route.params?.rideId;

  const [selected, setSelected] = useState<string>("changed_mind");
