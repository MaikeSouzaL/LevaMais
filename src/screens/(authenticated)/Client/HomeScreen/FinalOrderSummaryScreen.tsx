...
export default function FinalOrderSummaryScreen() {
  ...
  if (!data) {
    return (
      ...
      >
        <Text style={{ color: "white" }}>Sem dados do pedido.</Text>
        <TouchableOpacity
          onPress={() => navigation.goBack()}
          style={{ marginTop: 12 }}
        >
          <Text style={{ color: "#02de95", fontWeight: "700" }}>Voltar</Text>
        </TouchableOpacity>
      </SafeAreaView>
    );
  }

  const vehicleIconName = { moto: "🛵", car: "🚗", van: "🚐", truck: "🚚" }[
    data.vehicleType
  ];
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0f231c" }}>
      ...
      >
        ...
        <TouchableOpacity style={{ padding: 8 }}>
          <Text style={{ color: "#02de95", fontWeight: "700" }}>Editar</Text>
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <View style={{ flexDirection: "row", columnGap: 16, marginBottom: 12 }}>
          <View style={{ width: 24, alignItems: "center" }}>
        ...
        >
          ...
          >
            ...
            <Text style={{ color: "#02de95", fontWeight: "800", fontSize: 24 }}>
